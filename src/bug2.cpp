...
//				ROS_INFO("dist_traveled: %f \n", dist_traveled);
			...
			current_slope = (goal_y-current_pos_y)/(goal_x-current_pos_x);
			if (goal_x>current_pos_x && current_pos_x> 0 && goal_y>current_pos_y && current_pos_y>0 && slope>=current_slope-slope_error && slope <= current_slope+slope_error)
			{
				testing = false;
				
			}
			ROS_INFO("slope: %f, current slope: %f, current truth: %d", slope, current_slope ,(goal_x>current_pos_x && current_pos_x> 0 && goal_y>current_pos_y && current_pos_y>0 && slope>=current_slope-slope_error && slope <= current_slope+slope_error));
